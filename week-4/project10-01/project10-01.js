...
// Add event listeners to each puzzle piece for the pointerdown event
for (let i = 0; i < pieces.length; i++) {
   pieces[i].addEventListener("pointerdown", grabPiece);
}

// grabPiece function implementation
...
// movePiece function implementation
...
// dropPiece function implementation
